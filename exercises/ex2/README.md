...
2. Open the **Destinations** view (to be found in the Connectivity area in the navigation pane).
    ...
    <br>![alt text](../ex2/images/image-1.png)
...
2. Go to the **Features** application.
    ...
    <br>![alt text](../ex2/images/image-5.png)
